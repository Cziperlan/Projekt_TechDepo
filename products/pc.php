    ...
    <div class="product-page">
        <div class="product-container">
            ...
            <div class="slideshow-section">
                <div class="slideshow">
                    <img src="../Képek/<?= urlencode($product['ProID']); ?>.jpg" alt="Product Image 1" class="active">
                    <img src="../Képek/<?= urlencode($product['ProID']); ?>-1.jpg" alt="Product Image 2">
                </div>
                <div class="thumbnails">
                <div class="thumbnail active" data-index="0">
                    <img src="../Képek/<?= urlencode($product['ProID']); ?>.jpg" alt="Thumbnail 1">
                </div>
                <div class="thumbnail" data-index="1">
                    <img src="../Képek/<?= urlencode($product['ProID']); ?>-1.jpg" alt="Thumbnail 2">
                </div>
                </div>
            </div>
